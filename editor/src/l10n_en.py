l10nEn = {
    ...
    "m_open_ini_file": "Open EasyPromptAnimeEditor.ini",
    "m_open_default_prompt_file": "Open default prompt file",
    "m_open_prompt_travel_template_file": "Open prompt travel template file",
    "m_anime": "Anime",
