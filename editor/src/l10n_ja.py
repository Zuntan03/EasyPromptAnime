l10nJa = {
    ...
    "ip_adapter_use": "イメージプロンプト(IP)アダプタを使用",
    ...
    "m_open_ini_file": "簡単プロンプトアニメの設定 ini ファイルを開く",
    "m_open_default_prompt_file": "デフォルトのプロンプトファイルを開く",
    "m_open_prompt_travel_template_file": "プロンプトトラベルのテンプレートファイルを開く",
    "m_anime": "アニメ",
